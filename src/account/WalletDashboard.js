...
const API = "https://easybuy-backend-85si.onrender.com/api/cards";
...
const fetchWallet = async () => {
  ...
  const handleAddMoney = async (amount) => {
    ...
    try {
      const res = await fetch("https://easybuy-backend-85si.onrender.com/api/payments/razorpay/order", {
        method: "POST",
        headers: {
      ...
      const options = {
        ...
        handler: async function (response) {
          // ✅ VERIFY + ADD MONEY
          await fetch("https://easybuy-backend-85si.onrender.com/api/cards/add-money", {
            method: "POST",
            headers: {
              "Content-Type": "application/json"
            },
  ...
  const handlePay = async () => {
    ...
    try {
      ...
      const options = {
        ...
        handler: async function (response) {
          try {
            await fetch("https://easybuy-backend-85si.onrender.com/api/payments/verify", {
              method: "POST",
              headers: { "Content-Type": "application/json" },
