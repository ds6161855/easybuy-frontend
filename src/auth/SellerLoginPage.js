...
const SellerLoginPage = () => {
  ...
  const handleSendOtp = async () => {
    ...
    try {
      const res = await fetch("https://easybuy-backend-85si.onrender.com/api/seller/login/send-otp", {
        method: "POST",
  ...
  const handleVerifyOtp = async () => {
    ...
    try {
      const res = await fetch("https://easybuy-backend-85si.onrender.com/api/seller/login/verify", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
